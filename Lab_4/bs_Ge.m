%% BS_GE.M [GERMANIO - BANDE E POPOLAMENTO]
...
a=a_Ge;%[m]
b=2*pi/a;%[m-1]
kx0=0.5*2*pi/a;%[m-1] coordinata kx del minimo CB-Ge
ky0=0.5*2*pi/a;%[m-1] coordinata ky del minimo CB-Ge
kz0=0.5*2*pi/a;%[m-1] coordinata kz del minimo CB-Ge
