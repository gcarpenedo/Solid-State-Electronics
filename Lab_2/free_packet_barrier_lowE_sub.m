function [T] = free_packet_barrier_lowE_sub(V0,E0,a)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% E0=55.d-3;       %[eV] (energia del pacchetto)
% V0=60.d-3;       %[eV] (altezza della barriera)
% a=4e-9;          %[m]  (larghezza della barriera)

k0=(2*m*q*E0)^.5/hb;                 %[m-1]
k0_=k0*(2*q*V0*m/hb^2/k0^2-1.d0)^.5; %[m-1]
...
for kt=-30:90;
 ...
 y_r=zeros(1,length(x_r));
    ...
    for ke=-40:40
     k=k0+ke*dk;
     k_=k*(2*q*V0*m/hb^2/k^2-1.d0)^.5; %[m-1]
     w=hb*k^2/2/m;                    %[rad/s]
